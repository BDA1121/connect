var emojiStore         = document.querySelector("#emojiStore"),
    ...
    bwMyself           = document.querySelector("#bwMyself"),
...
bwMyself.style.opacity = "0";
	mute.style.opacity = "0";
	pause.style.opacity = "0";
vid.addEventListener("mouseenter",function(){
	bwMyself.style.opacity = "1";
...
//-----------------------b&w-------------------------------------------------------------
bwMyself.addEventListener('click', function(ev){
	io.emit('signal',{"type":"user_here", "message":"b&w", "room":signalRoom});
	console.log("going to b&w ur video");
	if(!bw){
		myVideoArea.classList.add("bw");
		bwMyself.style.background = "black";
	bwMyself.style.color = "white";
		bw = true;
	}
	else{
		bwMyself.style.background = "white";
	bwMyself.style.color = "black";
		myVideoArea.classList.remove("bw");
		bw =false;
	}
	ev.preventDefault();
}, false);
